...
<link rel="stylesheet" type="text/css" href="public/UI/style/css/style-main.css"/>
		...
		<div class="header"> 
			<div class="box-header-01">
				<div class="container">
					<div class="row">
					<div class="logo">
					<a href="index.php"><img src="public/UI/images/logodefault.png" alt=""/></a>
					</div>
					<div class="menu">
						<div class="box-main-menu">
							<div class="main-menu">
								<ul>
									...
									<div class="content"><img alt="" src="public/UI/images/sale-mega-01.png" />
																  ...
																  <div class="item">
																    <div class="item-wrap">
																      <div class="item-image">
																        ...
																        <img class="first_image" src="public/" alt="Product demo" /> 
																        </a>
																    <div class="item-btn">
																      <div class="box-inner">
					...
					<div class="content">
						...
						<ul class="right">
							<li class="language"><a href="#" class="selected"><img src="images/flags/flag-french.jpg" alt=""/>French</a>
									<ul>
										<li><a href="home-01.html"><img src="images/flags/flag-default.jpg" alt=""/>English</a></li>
										<li><a href="home-02.html"><img src="images/flags/flag-french.jpg" alt=""/>French</a></li>
									</ul>
							</li>
							...
							<div class="block-content">
							   <div class="inner">
								  ...
								  <ol id="cart-sidebar" class="mini-products-list">
									 <li class="item">
										<a href="#" title="Fashion Ipad Air and iOS7" class="product-image">
										<img src="images/product/small/image-demo-1.jpg" alt="Fashion Ipad Air and iOS7" />
										</a>
										<a href="#" class="btn-remove">Remove This Item</a>
										<a href="#" title="Edit item" class="btn-edit">Edit item</a>
										<div class="product-details">
										   <p class="product-name"><a title="Fashion Ipad Air and iOS7" href="#">Fashion Ipad Air and iOS7</a></p>
			...
			<div class="box-header-03">
				<div class="container">
					<div class="row">
						...
						<form action="index/html/mello/detail.html?q=exp" method="POST">
							...
							<input name="" type="text" value="" placeholder="search this site..."/>
						</form>
						</div>
					</div>
				</div>
...
<div class="content">
	...
	<div class="container">
		...
		<div class="row">
						 ...
						 <div class="products-grid">
							<div class="item">
							   <div class="item-wrap">
								  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
									 <img class="first_image" src="public/UI/images/product/larg/demo6.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
							...
							<div class="item">
							   <div class="item-wrap">
								  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
									 <img class="first_image" src="public/UI/images/product/larg/demo7.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
							...
							<div class="item">
							   <div class="item-wrap">
								  <div class="item-image">
									 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
									 <img class="first_image" src="public/UI/images/product/larg/demo8.jpg" alt="Product demo" /> 
									 </a>
									 <div class="item-btn">
										<div class="box-inner">
										   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
			...
			<div class="carousel-inner">
			<div class="item active"><a href="#"><img src="public/UI/images/banner13.png" alt="banner" /></a>
				<div class="std">
			...
			<div class="item"><a href="#"><img src="public/UI/images/banner14.png" alt="banner" /></a>
				<div class="std">
			...
			<div class="item"><a href="#"><img src="public/UI/images/banner15.png" alt="banner" /></a>
				<div class="std">
			...
			<div id="main" class="col-lg-9 col-md-9 col-sm-8 col-xs-12 col-main">
				...
				<form action="#" method="post" id="product_addtocart_form">
						...
						<div class="product-img-box">
							 ...
							 <img  src="public/UI/images/product/larg/demo6.jpg" alt="Product demo" /> 
							 </div>
							 ...
							 <div id="galary-image" class="carousel slide" data-ride="carousel">
								  ...
								  <div class="carousel-inner" role="listbox">
									<div class="item active">
										<div class="sub-item">
									    <img src="public/UI/images/product/larg/demo1.jpg" alt="Chania">
										</div>
										<div class="sub-item">
									    <img src="public/UI/images/product/larg/demo3.jpg" alt="Flower">
										</div>
										<div class="sub-item">
									    <img src="public/UI/images/product/larg/demo4.jpg" alt="Flower">
										</div>
									</div>

									<div class="item">
									  <div class="sub-item">
									  <img src="public/UI/images/product/larg/demo2.jpg" alt="Chania">
									  </div>
									  <div class="sub-item">
									  <img src="public/UI/images/product/larg/demo5.jpg" alt="Chania">
									  </div>
									  <div class="sub-item">
									  <img src="public/UI/images/product/larg/demo6.jpg" alt="Chania">
									  </div>
									</div>
								  </div>
							...
							<div class="image-quick-view no-display">
								...
								<img src="public/UI/images/product/larg/demo6.jpg" alt=""/>
								</div>
							</div>
						</div>
						<div class="product-shop">
							...
							<div class="short-description">
								<div class="std"><span>
								At vero eos et accusamus et iusto ods un dignissimos ducimus qui blan ditiis prasixer esentium voluptatum un deleniti atqueste sites excep turiitate non provide ntsimils.</span>
								</div>
				...
				<div class="container">
					<div class="row">
						<div class="box-left">
							...
							<h6>Nafi Computer &copy; 2016. All Rights Reserved. Designed by <a title="ssoftbd.com" href="http://ssoftbd.com/" target="_blank">Speard Software Solution</a></h6>
						</div>
				        <?php
